...
public class ApiConstants {
    ...
    public static final String CODE = "3ab66271d170aa2f0c464967a0a946b4991e781bcd8a11aff77b4d453a05b7fb";
    ...
    /* Exceptions */
    public static final String CANT_CONNECCT_TO_INTERNET = "Немає інтернет зєднання. Без нього робота з додатком не можлива";
    public static final String REQUEST_LIMIT_EXCEPTION = "Перевищено ліміт зєднаь з UnsplashAPI для користувача. Зачекайте до кінця години ";
